...
@inject('appStore')
@observer
class GradeIOfficers extends React.Component {

    constructor(props) {
        super(props);
        this.state = { loading: true, filter: 'Appointed Officers in Grade I Posts' };
    ...
    filterData = (data) => {
        ...
        if (filter == 'Appointed Officers in Grade I Posts') {
            var temp = [];
            data.forEach(element => {
                if (element.officer_grade == 2 && element.nature_of_attachment == 'Permanent' && element.position_grade == 2) {
                    temp.push(element)
                }
            });
            return temp;
            ...
            var temp = [];
            data.forEach(element => {
                if (element.officer_grade == 2 && element.position_grade == 7) {
                    temp.push(element)
                }
            });
            return temp;
            ...
            var temp = [];
            data.forEach(element => {
                if (element.officer_grade == 2 && element.position_grade == 6) {
                    temp.push(element)
                }
            });
            return temp;
            ...
            var temp = [];
            data.forEach(element => {
                if (element.nature_of_attachment == 'SLAS - Cabinet Acting' && element.position_grade == 2) {
                    temp.push(element)
                }
            });
            return temp;
            ...
            var temp = [];
            data.forEach(element => {
                if (element.nature_of_attachment == 'SLAS - PSC Acting' && element.position_grade == 2) {
                    temp.push(element)
                }
            });
            return temp;
            ...
            var temp = [];
            data.forEach(element => {
                if (element.nature_of_attachment == 'SLAS - PSC Contract Basis' && element.position_grade == 2) {
                    temp.push(element)
                }
            });
            return temp;
            ...
            <div>
                ...
                <Card className="card-magrin">
                    <div>
                        <Text>Type : </Text>
                        <Select
                            defaultValue="Appointed Officers in Grade I Posts"
                            style={{ width: 400 }}
                        ...
                        >
                            <Option value="Appointed Officers in Grade I Posts">Appointed Officers in Grade I Posts</Option>
