...
@inject('appStore')
@observer
class SecondmentReport extends React.Component {
            ...
            <div>
                <Card bordered={false}>
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item>
                            Secondment/Other Posts
                        </Breadcrumb.Item>
                    </Breadcrumb>

                    <Title level={4}>Secondment/Other Posts</Title>
                </Card>
...
export default SecondmentReport;